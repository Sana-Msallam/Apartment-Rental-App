...
class AppStrings {
  ...
  String get deleteConfirm => isAr ? "هل أنت متأكد من حذف هذه الشقة؟" : "Are you sure you want to delete this apartment?";
  String get delete => isAr ? "حذف" : "Delete";
  String get startDescription => isAr ? "جد منزلك المثالي بسهولة" : "Find your perfect home easily";
  ...
  String get emailRequired => isAr ? "البريد الإلكتروني مطلوب" : "Email required";
  String get invalidEmail => isAr ? "يرجى إدخال بريد إلكتروني صحيح" : "Invalid email";
  String get phoneRequired => isAr ? "رقم الهاتف مطلوب" : "Phone required";
  String get phoneInvalid => isAr ? "رقم الهاتف يجب أن يكون 10 أرقام على الأقل" : "Invalid phone number";
  String get createPassword => isAr ? "إنشاء كلمة مرور" : "Create Password";
  String get passwordInstruction => isAr ? "اختر كلمة مرور قوية لحماية حسابك." : "Choose a strong password.";
  ...
  String get passNotMatch => isAr ? "كلمات المرور غير متطابقة" : "Passwords do not match";
  String get uploadDocuments => isAr ? "رفع المستندات" : "Upload Documents";
  String get uploadInstruction => isAr ? "يرجى رفع صورك للتحقق من الحساب." : "Upload photos for verification.";
  String get personalPhoto => isAr ? "الصورة الشخصية" : "Personal Photo";
  String get idPhoto => isAr ? "صورة الهوية" : "ID Photo";
  String get finishRegistration => isAr ? "إنهاء التسجيل" : "Finish Registration";
  String get errorUploadBoth => isAr ? "يرجى رفع كلتا الصورتين!" : "Upload both images!";
  ...
  String get noApartments => isAr ? "لا يوجد شقق حالياً." : "No apartments found.";
  ...
  String get selectGovFirst => isAr ? "اختر المحافظة أولاً" : "Select Governorate First";
  ...
  String get descriptionHint => isAr ? "صف شقتك هنا..." : "Describe your apartment...";
  String get addApartmentButton => isAr ? "إضافة الشقة" : "Add Apartment";
  String get imagesSelected => isAr ? "صور مختارة" : "Images Selected";
  String get uploadPhotos => isAr ? "ارفع صور الشقة" : "Upload apartment photos";
 ...
 Map<String, String> get dbToAr => {
  ...
  String get areYouSureLogout => isAr ? "هل أنت متأكد من تسجيل الخروج؟" : "Are you sure you want to logout?";
...
String get logout => isAr ? "تسجيل الخروج" : "Logout";
  ...
  String get imageError => isAr ? "يرجى رفع صورة واحدة على الأقل" : "Please upload at least one image";
  String get locationError => isAr ? "يرجى اختيار المحافظة والمدينة" : "Please select location";
  String get addSuccess => isAr ? "تم إضافة الشقة بنجاح!" : "Apartment Added Successfully!";
  String get addError => isAr ? "فشل في الإضافة، حاول مجدداً" : "Failed to add apartment";
  String get descriptionRequired => isAr ? "الوصف مطلوب" : "Description is required";
  String get descriptionTooShort => isAr ? "الوصف قصير جداً" : "Description too short";
  String get selectTitleDeed => isAr ? "اختر نوع الملكية" : "Select Title Deed";


String get noActiveBookings => isAr ? "لا توجد حجوزات نشطة" : "No active bookings";
String get noPastBookings => isAr ? "لا توجد حجوزات سابقة" : "No past bookings";
String get noCancelledBookings => isAr ? "لا توجد حجوزات ملغاة" : "No cancelled bookings";
...
// --- نصوص صفحة الحجز (Booking Page) ---
  ...
  String get selectStartFirstError => isAr ? "يرجى اختيار تاريخ البدء أولاً" : "Please select start date first";
  String get datesRequiredError => isAr ? "يرجى تحديد التاريخين" : "Please select both dates";
  String get loginRequiredError => isAr ? "يرجى تسجيل الدخول أولاً" : "Please login first";
  String get serverError => isAr ? "خطأ في الاتصال، يرجى المحاولة لاحقاً" : "Server error, please try again later";
  String get bookingSuccess => isAr ? "تم الحجز بنجاح!" : "Reservation Successful!";
  String get updateSuccess => isAr ? "تم تحديث الموعد بنجاح!" : "Update Successful!";
